...
ACT_8="Выход"
#ACT_9="Установка SuperSU (ver.2.79)"
#ACT_10="Подмена ID устройства под международную прошивку"
#ACT_11="Подмена ID устройства под китайскую прошивку"
#ACT_12="Подмена ID устройства под бета прошивку"
